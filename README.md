...
If you are looking for an implementation with lines instead of triangles, you could get it [here](https://github.com/notprathap/filled-ellipse/releases/tag/filled-ellipse-with-lines) - Please note not all pixels are painted within the ellipse, and hence the approach with triangles in the final version
